...
export function CharacterOverview({ onOpenCharacter, onOpenGM, onOpenGMSession, onCreateCharacter }) {
  const { data, ready, authLoading, profile, currentUserId, activeWorkspace, acceptWorkspaceInvite, attachCharacterToCampaign, deleteCharacter, setActiveCharacter, upsertCharacter } = useGameStore();
  ...
  const characterWorkspaceFilter = showUserGroups ? "" : activeWorkspaceId;
